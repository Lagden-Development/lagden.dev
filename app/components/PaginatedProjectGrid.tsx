...
const ProjectCard = ({
  ...
  <TiltCard className="group relative h-[360px]">
    <Link
    ...
    >
      ...
      <div className="relative h-full overflow-hidden rounded-xl border border-gray-800/80 bg-black/50 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-md transition-all duration-300 hover:border-violet-500/30 hover:shadow-[0_0_25px_rgba(124,58,237,0.2)] focus-visible:border-violet-500/30">
