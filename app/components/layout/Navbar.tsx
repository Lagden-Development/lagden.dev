          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="relative overflow-hidden rounded-full border border-gray-800/50 p-2 text-gray-400 transition-all duration-300 hover:border-violet-500/30 hover:text-white hover:shadow-[0_0_15px_rgba(124,58,237,0.2)] md:hidden"
                onClick={toggleMenu}
              >
