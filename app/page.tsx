    ...
    <div className="relative min-h-screen overflow-visible py-24">
      ...
      <section className="relative mb-32 text-center">
        <div className="relative">
          ...
          {/* Hero title with sophisticated gradient and effects */}
          <h1 className="relative mb-6 text-6xl font-bold tracking-tight text-white transition-all duration-700 sm:text-7xl">
            We are{' '}
            <span className="relative inline-block bg-gradient-to-br from-violet-400 to-fuchsia-300 bg-clip-text text-transparent">
              Lagden Development
              <div className="animate-glow-smooth absolute -right-3 top-0 h-24 w-24 bg-gradient-to-r from-violet-500/20 to-transparent blur-2xl" />
            </span>
          </h1>

          <p className="mx-auto mb-8 max-w-2xl bg-gradient-to-br from-gray-200 to-gray-400 bg-clip-text text-xl text-transparent">
          ...
          <div className="flex justify-center space-x-4">
            <Button
              className="group relative overflow-hidden rounded-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-indigo-500 px-8 py-6 text-lg font-medium text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(124,58,237,0.5)]"
              asChild
            >
              <Link href="/projects">
      ...
      {/* Highlights Section with refined cards */}
      <div className="mb-32 grid grid-cols-1 gap-8 sm:grid-cols-3">
        {highlights.map((item, index) => (
          <div key={item.label} className="group relative">
            ...
            <div className="relative overflow-hidden rounded-xl border border-gray-800/80 bg-black/50 p-6 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-md transition-all duration-300 hover:border-violet-500/30 hover:shadow-[0_0_25px_rgba(124,58,237,0.2)]">
              ...
              <div className="relative flex items-center gap-4">
                <div
                  className={`relative overflow-hidden rounded-full bg-gradient-to-r ${item.gradient} p-3 transition-transform duration-300 group-hover:scale-110`}
                >
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,transparent_25%,rgba(0,0,0,0.2))]" />
                  <item.icon className="relative h-6 w-6 text-white transition-transform duration-300 group-hover:rotate-12" />
                </div>
                <div>
      ...
      <section className="mb-32">
        <div className="relative mb-12 text-center">
          ...
          <h2 className="relative mb-4 bg-gradient-to-br from-white to-gray-300 bg-clip-text text-4xl font-bold text-transparent">
            Featured Projects
          </h2>
      ...
      <section className="relative">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-800/80 bg-black/50 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-md">
          ...
          <div className="relative px-8 py-12 text-center sm:px-12">
            ...
            <h2 className="mb-4 mt-6 bg-gradient-to-br from-white to-gray-300 bg-clip-text text-4xl font-bold text-transparent">
              Let&apos;s Build Together
            </h2>
            <p className="mx-auto mb-8 max-w-2xl text-xl text-gray-400">
              Whether you&apos;re interested in collaboration, contributions, or
              just want to connect, we&apos;re excited to hear from you.
            </p>
